...
public class CartoonCharacter {
    ...
    public void walk(double dist) {
        this.erase();
        if (this.direction.equals("right")&&(this.characterX+dist<this.canvasWidth)){
    ...
    public void speak(String words) {
        ...
        if (words.equals("Want to see something cute?")) {
            this.drawCat();
        }
    }
    ...
    private void drawCat(){
        String fname = null;
        fname = "img\\Hesta_100x100.jpg"; 
        UI.drawImage(fname, this.characterX, this.characterY, 100, this.characterHeight);
        UI.sleep(500);
    }
